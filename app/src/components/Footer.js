...
export default function Footer() {
    ...
    <div className="flex flex-col items-center justify-between mx-auto max-w-screen-xl">
      ...
      <div className="flex items-center mt-12 mb-6">
        <a className="ml-4 flex items-center" href="/">
          ...
          <span className="inline-block ml-2 text-xl font-semibold tracking-wider uppercase text-gray-200">The Brella
            Guys</span>
        </a>
      </div>
      ...
      <div className="flex text-gray-300">
        <a className="hover:text-yellow-200" href="/">
          <svg className="mx-4 fill-current h-5 w-5" width="21" height="17" viewBox="0 0 21 17" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <title>Twitter</title>
            <path
        ...
        <a className="hover:text-yellow-200" href="/">
          <svg className="mx-4 fill-current h-5 w-5" width="20" height="20" viewBox="0 0 20 20" fill="none"
            xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="flex w-full justify-center gap-x-4 text-xs mt-24">
    ...
    <div className="flex flex-col items-center mt-4 text-xs text-gray-400">
